            ...
            <div class="container">
                ...
                <div class="banner-main">
                    ...
                    <Tabs id="font-size"  :animated="false">
                        ...
                        <Tab-pane label="产品">
                            <Input v-model="chanpin"  placeholder="请输入..." size="large" style="width: 660px;border-radius: 4px 0 0 4px">
                            </Input>
        ...
        methods: {
            ...
            search(flag) {
                if(flag=='1'){
                    ...
                    window.open('http://192.168.7.61:8080/ovit/product/search.htm?name='+this.chanpin)
                }else if(flag=='5'){
                    window.open('http://192.168.7.61:8080/ovit/product/search.htm?name='+this.fuwu) 
                }else if(flag=='6'){

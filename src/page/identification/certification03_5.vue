								...
								<div slot="content">
									<Tabs v-model="tabname" size="small" :animated="false" @on-click="getname">
										<Tab-pane label="种植园地" name="种植园地">
											<span style="margin: 5px;" @click="savea()">种植标准 </span>
											<span style="margin: 5px;" @click="savea()">种植技术</span>
											<span style="margin: 5px;" @click="savea()">农事提醒</span>
											<span style="margin: 5px;" @click="savea()">育种技术</span>
											<span style="margin: 5px;" @click="savea()">育苗技术</span>
										</Tab-pane>
										<Tab-pane label="养殖园地" name="养殖园地">
											<span style="margin: 5px;" @click="savea()">养殖标准 </span>
											<span style="margin: 5px;" @click="savea()">养殖技术</span>
											<span style="margin: 5px;" @click="savea()">养殖提醒</span>
											<span style="margin: 5px;" @click="savea()">育种技术</span>
										</Tab-pane>
										...
										<Tab-pane label="农业工程" name="农业工程">
											<span style="margin: 5px;" @click="savea()">农村能源 </span>
											<span style="margin: 5px;" @click="savea()">水能应用</span>
											<span style="margin: 5px;" @click="savea()">风能应用</span>
											<span style="margin: 5px;" @click="savea()">太阳能</span>
											<span style="margin: 5px;" @click="savea()">地下热能</span>
										</Tab-pane>
	...
	export default {
		...
		methods: {
							...
							c.forEach((f, len) => {
								if(f.title == e) {
									...
									f.children.forEach((r, len1) => {
										if(r.title == e) {
											_this.knowledges[0].children[index].children[len1].splice(len1, 1)
										}
			...
			save() {
				axios({
					method: 'post',
					url: 'http://localhost:1111/indivi/ledge',
					data: {
						ledge: this.leibie,

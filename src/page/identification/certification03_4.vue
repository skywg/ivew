					...
					<Modal v-model="modal1" width="450" :closable="true" :mask-closable="false" class="gex" @on-ok="ok">
						...
						<Collapse accordion @on-change="getname1">
							<Panel name="党务">
								党务
								<div slot="content">
											<span style="margin: 5px;" @click="savea()">综合 </span>
											<span style="margin: 5px;" @click="savea()">组织</span>
											<span style="margin: 5px;" @click="savea()">宣传</span>
											<span style="margin: 5px;" @click="savea()">统战</span>
											<span style="margin: 5px;" @click="savea()">外联</span>
								</div>
							</Panel>
							...
							<Panel name="政务">
								...
								<div slot="content">
											<span style="margin: 5px;" @click="savea()">综合 </span>
											<span style="margin: 5px;" @click="savea()">外交</span>
											<span style="margin: 5px;" @click="savea()">国防</span>
											<span style="margin: 5px;" @click="savea()">发展</span>
											<span style="margin: 5px;" @click="savea()">教育</span>
								</div>
							</Panel>
							<Panel name="全团">
								全团
								<div slot="content">
											<span style="margin: 5px;" @click="savea()">工会 </span>
											<span style="margin: 5px;" @click="savea()">共青团</span>
								</div>
							</Panel>
	...
	export default {
		...
		methods:{
			...
			save(){
				axios({
						method: 'post',
						url: 'http://localhost:1111/indivi/policy',
						data: {
							ledge:this.leibie,

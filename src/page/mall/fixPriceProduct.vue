    ...
    <div class="wrapper">
        ...
        <section class="layouts">
            <div class="goods-list fix-price-product">
                ...
                <Row :gutter="10">
                    <Col span="4" v-for="item in priceList" class="mb20">
                        <a href="/mall/fixPriceProductDetail" class="goods">
                            ...
                            <Row class="pd10 info">
	                            ...
	                            <Col span="24" class="ell h6 mt5">{{item.title}}</Col>
	                            <Col span="24" class="ell mt10">{{item.pople}} 人说好<i class="icon-laud h6"></i></Col>
...
export default {
    ...
    methods: {
        ...
        handleForward(){
            this.page.current++
            if(this.priceList.length < 8) this.priceList = [...this.priceList, ...this.priceList]
        },
        // 后退
        handleBack(){
            if(this.page.current > 1){
                this.page.current--
                this.priceList = this.priceList.slice(0,4)
            }

            ...
            <div class="goods-list group-buy-list">
                ...
                <Row :gutter="24">
                    <Col span="6" v-for="item in auctionList" class="mb20">
                        <a href="/mall/hotGroupBuyDetail" class="goods">
                            <div class="hd">
                                距离结束：
                            ...
                            <Row class="pd10 info">
                                <Col span="8" class="tc">
                                    <p class="h4 t-orange">￥{{item.price1}}</p>
                            ...
                            <div class="fd">
                                <Row>
                                    <Col span="17" style="padding:5px 10px;">
                                        <p class="h6 t-grey">
                                            距离 <span class="t-orange">￥{{item.distanPrice}}</span> 还差 
                                            <span class="t-orange">{{item.difference}}</span> 件
                                        </p>
                                        <p class="t-grey">{{item.pople}}人已购买</p>
                                    </Col>
                                    <Col span="7">

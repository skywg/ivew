    ...
    <div class="wrapper">
        ...
        <section class="layouts">
            ...
            <div class="goods-list group-buy-list">
                ...
                <Row :gutter="24">
                    <Col span="6" v-for="item in presellList" class="mb20">
                        <a href="/mall/newPresellDetail" class="goods">
                            <div class="hd">
                                距离结束：
...
export default {
    ...
    methods: {
        ...
        handleForward(){
            this.page.current++
            if(this.presellList.length < 8) this.presellList = [...this.presellList, ...this.presellList]
        },
        // 后退
        handleBack(){
            if(this.page.current > 1){
                this.page.current--
                this.presellList = this.presellList.slice(0,4)
            }

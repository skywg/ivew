    ...
    <div class="wrapper">
        ...
        <section class="layouts">
            ...
            <div class="goods-list hot-auction">
                ...
                <Row :gutter="24">
                    <Col span="6" v-for="item in hotAuctionList" class="mb20">
                        <a href="/mall/ypAuctionDetail" class="goods">
                            <div class="hd">
                                距离结束：
                                <clocker :time="item.time" slot="value">
                                    <span class="item">%D</span>天
            ...
            <div class="goods-list hot-auction">
                ...
                <Row :gutter="24">
                    <Col span="6" v-for="item in auctionList" class="mb20">
                        <a href="/mall/ypAuctionDetail" class="goods">
                            <div class="hd">
                                距离结束：
                                <clocker :time="item.time" slot="value">
...
export default {
    ...
    created(){
        this.auctionList = this.hotAuctionList
    },
    methods: {
        // 搜索
        handleSearch (query) {
        ...
        handleForward(){
            this.page.current++
            if(this.auctionList.length < 8) this.auctionList = [...this.auctionList, ...this.auctionList]
        },
        // 后退
        handleBack(){
            if(this.page.current > 1){
                this.page.current--
                this.auctionList = this.auctionList.slice(0,4)
            }

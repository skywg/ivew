...
<template>
    <div class="main-bot">
        ...
        <div class="mian-bot1" style="height:100px;">
...
<!--                    &lt;!&ndash;显示开始&ndash;&gt;
  ...
  <Date-picker type="daterange" placement="bottom-end" placeholder="选择日期" style="width: 200px"></Date-picker>
        ...
        <div class="mian-bot1" style="padding-top: 20px;height:100px;">
            <div class="mian-bot1-title" >
                <span>联系方式</span>
                &nbsp;
                <div  style="float: right">
        ...
        <div class="mian-bot1" style="padding-top: 20px;height:200px;">
            <div class="mian-bot1-title" >
                <span>教育经历</span>
                &nbsp;
                <div  style="float: right">
        ...
        <div class="mian-bot1" style="padding-top: 20px;height:auto;">
            <div class="mian-bot1-title" >
                <span>政治面貌</span>
                &nbsp;
                <div  style="float: right">
        ...
        methods: {
            ...
            findContactInfo: function () {
                axios.get('http://localhost:1111/contactInfo/findContactInfo')
                    .then(response => {
                        this.contract = "手机号："+response.data.mobile+",座机：" + response.data.phone +",QQ号："  + response.data.qq +",邮编："  + response.data.postcode +",邮箱："  + response.data.email +",所在地:"  + response.data.location +",通信地址："  + response.data.address +",我的位置："  + response.data.position+"。"
                    }).catch(function (error) {
                    console.log(error)
                })
            },

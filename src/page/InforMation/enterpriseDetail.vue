        ...
        <div class="main">
            ...
            <div class="main-bot">
                <div class="main-bot-title">
                    ...
                    <h3>特色介绍</h3>
                    <p>湖北帝昊源生物工程有限公司主要经营中药材种植开发、优良品种推广、中药材加工及生物技术研发业务，下辖两个分公司（湖北保康帝豪中药材种植有限责任公司、
湖北帝旺豪药业有限公司），两个合作社（保康县帝歌药材种植农民专业合作社、南漳帝乡农民专业合作社）。<br/><br/>
公司围绕“规模化种植、产业化经营、标准化生产、品牌化战略”方针，走稳健、务实、创新、高效的企业发展之路。并成立了院士（专家）工作站，与湖北华中农
业大学对接，对中药材种苗进行优质培育，打造道地中药材品牌；与湖北文理学院化学工程与食品科学学院合作研发，集药用、食用、保健、强神、美容为一体的系
列化中药材研发和深加工项目建设。目前，菊花保健食品、饮品、丹参提取液等产品己研发成功，现已形成完整的服务体系。<br/><br/>
湖北帝昊源生物工程有限公司有限公司规划在3-5年时间打造电子商务、智慧物流管理、智慧养老、网络传媒方面的运营体系。同时，公司通过企业资源整合、消费者
数据库储备、全链条运维体系，为项目、合作伙伴提供多渠道优质整合平台，为企业提供专业的“互联网＋”的综合解决方案。</p>
                    </div>
                    <div>
                        <h3>特色介绍</h3>
                        <Row style="text-align: center">
                            <Col span="4" style="width: 177px; margin-right: 28px;">
                            <div >
                                <div class="img-border">
                                <img src="../../img/baicai.png" alt="">
                                </div>
                                <p style="line-height: 30px;margin-bottom: 10px">¥180</p>
                            </div>
                            </Col>
                            <Col span="4" style="width: 177px; margin-right: 28px;">
                            <div >

        ...
        <div class="container">
            <div class="searchList">
                ...
                <Breadcrumb separator=">">
                    ...
                    <Breadcrumb-item href="/pro/knowledgeList?flag=3">知识</Breadcrumb-item>
...
export default {
    ...
    methods: {
        fetchData: function () {
            this.list = []
            axios.get('http://localhost:1111/knowLege/findKnowLedgeDetail?id=' + this.$route.query.id)
                .then(response => {
        ...
        findComment() {
            axios.get('http://localhost:1111/knowLege/findKnowLedgeComment/' + this.currentPage + '?id=' + this.$route.query.id + '&pageSize=' + this.pageSize)
                .then(response => {
        ...
        myComment() {
            if(this.user){
                axios.get('http://localhost:1111/knowLege/findMyComment/' + this.currentPage + '?id=' + this.$route.query.id + '&pageSize=' + this.pageSize)
                    .then(response => {
        ...
        upvote() {
            axios.get('http://localhost:1111/knowLege/upvote?id=' + this.$route.query.id)
                .then(response => {
        ...
        reply(id) {
            axios({
                method: 'post',
                url: 'http://localhost:1111/knowLege/saveHuiFu',
                data: {
                    postId: id,
        ...
        dianzan(id) {
            axios.get('http://localhost:1111/knowLege/saveZan?id=' + id)
                .then(response => {
        ...
        goToPrevious(id){
            axios.get('http://localhost:1111/knowLege/findKnowLedgeDetail?id=' + id)
                .then(response => {
                    this.content = response.data.content
                    this.title = response.data.title
                    this.createTime = response.data.createTime
